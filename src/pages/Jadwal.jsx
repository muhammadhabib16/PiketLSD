...
export default function Jadwal() {
  ...
  return (
    <div className="max-w-5xl mx-auto w-full space-y-4 pb-6 animate-fadeIn">
      {/* 1. Header Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-slate-500">
                Matriks jadwal piket asisten lab LSD (Senin s.d. Jumat, 08:00 - 16:00 WIB)
              </p>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="self-start sm:self-auto px-3 py-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 active:scale-95 text-xs font-semibold text-slate-700 shadow-xs flex items-center gap-1.5 transition disabled:opacity-50"
        >
      ...
      <div className="rounded-2xl p-3.5 sm:p-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-blue-50 leading-relaxed">
            Asisten wajib piket minimal <strong className="text-white">2 Jam</strong> dengan batas check-in sebelum <strong className="text-white">14:00 WIB</strong>.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2.5">
          ...
          <div className="flex items-center gap-1 overflow-x-auto pb-1 sm:pb-0 scrollbar-none">
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition shadow-xs ${
                selectedDay === 'ALL'
            ...
            {daysList.map((day) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition flex items-center gap-1 shadow-xs ${
                    selectedDay === day
                      ? 'bg-blue-600 text-white'
                      : isToday
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
          {filteredJadwal.map((item) => {
            ...
            return (
              <div
                key={item.hari}
                className={`rounded-2xl p-4 bg-white border transition shadow-xs hover:shadow-md flex flex-col justify-between ${
                  isToday
                    ? 'border-blue-400 ring-2 ring-blue-500/20 bg-gradient-to-b from-blue-50/40 to-white'
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between pb-2.5 border-b border-slate-100">
                    <div className="flex items-center gap-2">
                      ...
                      {isToday && (
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-100 text-amber-900 border border-amber-300 flex items-center gap-1 shadow-xs">
                          ...
                          <div
                            ...
                            className={`p-2.5 rounded-xl border flex items-center justify-between gap-2 transition ${
                              isUser
                                ...
                                : 'bg-slate-50/70 border-slate-200/80 text-slate-800 hover:bg-slate-100/80'
                            }`}
                          >
                            <div className="flex items-center space-x-2.5 min-w-0">
                              ...
                              <div className="min-w-0">
                                <p className="text-xs font-bold truncate flex items-center gap-1">
                                  ...
                                  {isUser && (
                                    <span className="px-1 py-0.2 rounded bg-blue-600 text-white text-[8.5px] font-bold">
                                      Saya
                                    </span>
                                  )}
                                </p>
                            ...
                            <span className="text-[10px] font-mono font-medium px-2 py-0.5 rounded-md bg-white border border-slate-200 text-slate-600 flex-shrink-0">
                ...
                {/* Footer Info */}
                <div className="mt-3.5 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[10.5px] text-slate-400">
                  <span className="flex items-center gap-1">
                    <Clock className="w-3 h-3 text-slate-400" /> Waktu: 08:00 - 16:00 WIB
                  </span>
                  <span>Lab LSD</span>
                </div>
              </div>

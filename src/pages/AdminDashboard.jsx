    ...
    <div className="w-full space-y-4 pb-20 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            <button
              onClick={() => navigate('/')}
              className="p-1 rounded-lg hover:bg-slate-200/60 text-slate-500 transition"
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <button
            ...
            disabled={loading}
            className="px-3 py-1.5 rounded-xl bg-white border border-slate-200 text-blue-600 hover:bg-blue-50 transition shadow-sm text-xs font-semibold flex items-center gap-1.5"
          >
      ...
      <div className="flex items-center gap-2 p-1.5 bg-blue-50/80 rounded-xl border border-blue-200/80">
        ...
        >
          ...
          <span>Rekap Presensi Piket</span>
      ...
      {activeTab === 'presensi' ? (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-white rounded-xl p-3.5 border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase">Total Presensi</p>
              <p className="text-xl font-extrabold text-slate-900 mt-0.5">{totalAbsensi}</p>
            </div>
            <Users className="w-6 h-6 text-slate-400" />
          </div>

          <div className="bg-white rounded-xl p-3.5 border border-amber-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-amber-700 uppercase">Sedang Piket</p>
              <p className="text-xl font-extrabold text-amber-700 mt-0.5">{activeCount}</p>
            </div>
            <Clock className="w-6 h-6 text-amber-600" />
          </div>

          <div className="bg-white rounded-xl p-3.5 border border-emerald-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-emerald-700 uppercase">Selesai</p>
              <p className="text-xl font-extrabold text-emerald-700 mt-0.5">{completedCount}</p>
            </div>
            <CheckCircle2 className="w-6 h-6 text-emerald-600" />
          </div>

          <div className="bg-white rounded-xl p-3.5 border border-rose-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-rose-700 uppercase">Alpa</p>
              <p className="text-xl font-extrabold text-rose-700 mt-0.5">{alpaCount}</p>
            </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-white rounded-xl p-3.5 border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase">Total Izin</p>
              <p className="text-xl font-extrabold text-slate-900 mt-0.5">{totalIzin}</p>
            </div>
          ...
          <div className="bg-white rounded-xl p-3.5 border border-amber-200 shadow-sm flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-extrabold text-amber-700 mt-0.5">{pendingIzinCount}</p>
            </div>
            <Clock className="w-6 h-6 text-amber-600" />
          </div>
          ...
          <div className="bg-white rounded-xl p-3.5 border border-emerald-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-emerald-700 uppercase">Disetujui</p>
              <p className="text-xl font-extrabold text-emerald-700 mt-0.5">{approvedIzinCount}</p>
            </div>
            <CheckCircle2 className="w-6 h-6 text-emerald-600" />
          </div>
          ...
          <div className="bg-white rounded-xl p-3.5 border border-rose-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-rose-700 uppercase">Ditolak</p>
              <p className="text-xl font-extrabold text-rose-700 mt-0.5">{rejectedIzinCount}</p>
            </div>
                          ...
                          {isPending ? (
                            <div className="flex items-center justify-center gap-1.5">
                              <button
                                ...
                                className="px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs flex items-center gap-1 shadow-sm transition active:scale-95 disabled:opacity-50"
                              >
                              ...
                              <button
                                ...
                                disabled={isRowLoading}
                                className="px-2.5 py-1 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs flex items-center gap-1 shadow-sm transition active:scale-95 disabled:opacity-50"
                              >
